...
window.PaginaDeTesterPersonalizado = Castelog.metodos.un_componente_vue2("PaginaDeTesterPersonalizado",
...
throw error;
  ...
  null);
window.PaginaDeTester = Castelog.metodos.un_componente_vue2("PaginaDeTester",
...
{ path:"/tester1",
name:"PaginaDeTester",
component:PaginaDeTester,
props:{ 
}
},
{ path:"/tester2",
name:"PaginaDeTesterPersonalizado",
component:PaginaDeTesterPersonalizado,
props:{ 
}
} ],
  { es:{ 
